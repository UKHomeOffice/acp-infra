...
output "elb_subnets" {
  ...
  value = zipmap(
    aws_subnet.elb_subnets.*.availability_zone,
    aws_subnet.elb_subnets.*.id,
  )
}
...
output "nat_subnets" {
  ...
  value = zipmap(
    aws_subnet.nat_subnets.*.availability_zone,
...
output "elb_cidr" {
  ...
  value = zipmap(
    aws_subnet.elb_subnets.*.availability_zone,
    aws_subnet.elb_subnets.*.cidr_block,
  )
}
...
output "nat_cidr" {
  ...
  value = zipmap(
    aws_subnet.nat_subnets.*.availability_zone,
    aws_subnet.nat_subnets.*.cidr_block,
  )
}
